package com.absjuniordev.workshopmongo.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandarError> objectNotfaund(ObjectNotFoundException e, HttpServletRequest request) {
